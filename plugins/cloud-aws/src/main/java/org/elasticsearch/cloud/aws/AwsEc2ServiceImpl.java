...
public class AwsEc2ServiceImpl extends AbstractLifecycleComponent<AwsEc2Service> implements AwsEc2Service {
    ...
    public synchronized AmazonEC2 client() {
        ...
        String protocol = settings.get(CLOUD_AWS.PROTOCOL, "https").toLowerCase(Locale.ROOT);
        protocol = settings.get(CLOUD_EC2.PROTOCOL, protocol).toLowerCase(Locale.ROOT);
