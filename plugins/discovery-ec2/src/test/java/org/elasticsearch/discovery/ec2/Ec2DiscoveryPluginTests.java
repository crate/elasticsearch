...
public class Ec2DiscoveryPluginTests extends ESTestCase {
    ...
    public void testClientSettingsReInit() throws IOException {
        final Settings settings1 = Settings.builder()
                ...
                .put(Ec2ClientSettings.ACCESS_KEY_SETTING.getKey(), "ec2_access_1")
                .put(Ec2ClientSettings.SECRET_KEY_SETTING.getKey(), "ec2_secret_1")
                .put(Ec2ClientSettings.PROXY_USERNAME_SETTING.getKey(), "proxy_username_1")
                .put(Ec2ClientSettings.PROXY_PASSWORD_SETTING.getKey(), "proxy_password_1")
                .build();
        final Settings settings2 = Settings.builder()
                ...
                .put(Ec2ClientSettings.ACCESS_KEY_SETTING.getKey(), "ec2_access_2")
                .put(Ec2ClientSettings.SECRET_KEY_SETTING.getKey(), "ec2_secret_2")
                .put(Ec2ClientSettings.PROXY_USERNAME_SETTING.getKey(), "proxy_username_2")
                .put(Ec2ClientSettings.PROXY_PASSWORD_SETTING.getKey(), "proxy_password_2")
                .build();
